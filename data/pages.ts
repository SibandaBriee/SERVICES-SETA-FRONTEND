...
export const pages: Record<string, PageData> = {
  ...
  "about": {
    ...
    "intro": "Learn about our mandate, governance, leadership, strategy and performance.",
    "cards": [
      {
        "title": "Who we are",
        "text": "Our role within South Africa’s skills development landscape."
      },
      {
        "title": "Our mandate",
        "text": "The legislative and strategic basis for our work."
      },
      {
        "title": "Governance and leadership",
        "text": "Oversight, accountability and organisational leadership."
      },
      {
        "title": "Strategy and performance",
        "text": "Plans, priorities, performance and corporate reports."
      }
    ]
  }
};
